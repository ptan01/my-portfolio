...
const Footer = () => {
    return (
            ...
            <footer className="bg-inherit text-black py-8">
                <div className=" px-4">
                    <div className="flex flex-wrap items-center justify-center">
                        <div className="w-full md:w-1/2 lg:w-1/4 text-center mb-4 md:mb-0">
                            <h2 className="text-lg font-semibold text-white">Contact</h2>
                            <p className="text-gray-400 mt-2">Email: islamtanjim002@gamil.com</p>
                            <p className="text-gray-400">Phone: +8801302193675</p>
                        </div>
                        <div className="w-full md:w-1/2 lg:w-1/4 text-center mb-4 md:mb-0">
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/4 text-center mb-4 md:mb-0">
                            ...
                            <p className="text-gray-400 mt-2">Nilphamari</p>
                        ...
                        <div className="w-full md:w-1/2 lg:w-1/4 text-center">
                            ...
                            <p className="text-gray-400 mt-2">Subscribe to our newsletter for updates.</p>
                            <div className="mt-4">
                                <input
                                    type="email"
                    ...
                    <div className="flex flex-wrap items-center justify-around">
                        <div className="w-full md:w-auto text-center md:text-left">
                            <p className="text-gray-400">&copy; 2023 Tanjim Portfolio. All rights reserved.</p>
                        </div>
